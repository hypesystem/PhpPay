...
class PayPalAdapter extends PaymentAdapter {
    ...
    public function preparePayment($identifyingValue, Order $order) {
        ...
        return new PayPalPreparedPayment($identifyingValue, $this->expressCheckoutUrl, $this->apiUrl, $token, $options["VERSION"], $options["USER"], $options["PWD"], $options["SIGNATURE"]);
    }
